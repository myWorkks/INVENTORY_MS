...
public class ProductController {
	...
	public ResponseEntity<String> addProduct(@ModelAttribute AddProductDTO productDTO) throws  InventoryServiceException{
	...
	public ResponseEntity<ViewProductResponse> viewProduct(@RequestParam(name="pid",required = true)Long pid) throws InventoryServiceException{
